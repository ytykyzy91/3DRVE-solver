...
REM RVE-VAM Windows launcher using conda py39 environment
REM Usage examples:
REM   run_rve_py39.bat summary
REM   run_rve_py39.bat test
REM   run_rve_py39.bat run
REM   run_rve_py39.bat large
REM   run_rve_py39.bat fields
REM   run_rve_py39.bat fields-large

cd /d "%~dp0"

REM Activate conda py39 environment first
...
:help
echo RVE-VAM launcher (using conda py39 environment)
echo.
echo Commands:
echo   run_rve_py39.bat summary      Read VTU/JSON and print mesh/material mapping only
echo   run_rve_py39.bat test         Compile code and run built-in small verification
echo   run_rve_py39.bat run          Run stiffness homogenization with reduced sparse assembly
echo   run_rve_py39.bat large        Run stiffness homogenization with 1,000,000-scale settings
echo   run_rve_py39.bat fields       Run macro-strain local-field VTU output only
echo   run_rve_py39.bat fields-large Run macro-strain local-field VTU output only with large-mesh settings
echo   run_rve_py39.bat fields-homogenization Run fields plus 6-direction homogenization stiffness outputs
echo.
